...
"""
    try:
        response = requests.post(
            ...
            json={"model": "mistral", "prompt": prompt, "stream": False}import requests
from sklearn.feature_extraction.text import TfidfVectorizer
from sklearn.metrics.pairwise import cosine_similarity
import os

FIREWORKS_API_KEY = os.getenv("FIREWORKS_API_KEY")  # Set this in Streamlit secrets

def generate_custom_resume(resume_text, job_description, model="accounts/fireworks/models/mixtral-8x7b-instruct"):
